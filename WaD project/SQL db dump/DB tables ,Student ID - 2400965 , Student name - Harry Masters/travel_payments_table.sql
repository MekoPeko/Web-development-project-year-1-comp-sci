...
CREATE TABLE `payments_table` (
  ...
  `payments_cardholder_name` varchar(45) NOT NULL,
  `payments_cardNum` varchar(10) NOT NULL,
  `payments_Expiry_date` int NOT NULL,
  `payments_CVV` int NOT NULL,
  PRIMARY KEY (`payment_id`),
  KEY `fk_user_ID_idx` (`user_id`),
  KEY `fk_booking_ID_idx` (`booking_id`),
  KEY `fk_payment_name_idx` (`user_id`),
  CONSTRAINT `fk_payment_flight` FOREIGN KEY (`booking_id`) REFERENCES `booking_table` (`flight_id`),
  CONSTRAINT `fk_payment_name` FOREIGN KEY (`user_id`) REFERENCES `accounts` (`ID`)
...
INSERT INTO `payments_table` VALUES (30,19,18,900.00,'2025-05-01 10:34:27','Dan smith','4321',1123,111);
